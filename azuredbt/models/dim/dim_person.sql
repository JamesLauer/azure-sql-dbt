{{ config(
    ...
    "ALTER TABLE {{ this }} ADD CONSTRAINT FK_dimperson_salescustomer FOREIGN KEY (CustomerID) REFERENCES dev_src.sales_customer(CustomerID)",
    "ALTER TABLE {{ this }} ALTER COLUMN PersonID INT NOT NULL",
    "ALTER TABLE {{ this }} ADD CONSTRAINT FK_dimperson_personbusinessentity FOREIGN KEY (PersonID) REFERENCES dev_src.person_businessentity(BusinessEntityID)",
    ]
)}}
